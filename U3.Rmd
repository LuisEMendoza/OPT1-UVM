...
FILA|BASE|Z|$X_i$|$X_{i+1}$|$X_{i+2}$|...|$X_{n}$|$H_i$|$H_{i+1}$|$H_{i+2}$|...|$H_{n}$|CTE
---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:
0|-|1|$a_{0i}$|$a_{0i+1}$|$a_{0i+2}$|...|$a_{0n}$|0|0|0|...|0|0
1|$H_i$|0|$a_{1i}$|$a_{1i+1}$|$a_{1i+2}$|...|$a_{1n}$|1|0|0|...|0|m
...
Retomemos el problema de la misma sección correspondiente al método gráfico, aprovechando que ya conocemos su resultado. Construyamos el tablero simplex:
